<div class="wrap">
	...
	<div class="socnet_wrap">
		...
		<div class="tablefilter">
			...
			<div class="socnet-creds">Learn more at <a href="https://wordpress.org/plugins/wpsocialstats/#description">Social Media Stats</a><br />
			Give us feedback at <a href="https://wordpress.org/support/plugin/wpsocialstats">Support Forum</a>
	    </div>
...
?></p></div>
		...
		<div class="socialmedia-buttons" style="float:right !important;margin-top:7px;display:none;">
			...
			<a href="http://twitter.com/share" class="twitter-share-button" data-text="WP Social Media Stats is an advanced social media analytics plugin that analyzes how your posts perform on Social Networks" data-count="horizontal" data-url="http://www.twitter.com/wpcream">Tweet</a>
			<g:plusone size="medium" href="http://www.wpsocialstats.com"></g:plusone>
			<iframe src="http://www.facebook.com/plugins/like.php?href=https://mysite.com&send=false&layout=button_count&width=100&show_faces=false&action=like&colorscheme=light&locale=en_US" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:21px;" allowTransparency="true"></iframe>
		</div>-->
	</div>
</div>
